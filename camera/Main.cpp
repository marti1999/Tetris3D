...
GLfloat vertices[] =
{ //     COORDINATES     /        COLORS      /   TexCoord (Textures)  //
...
int main()
{
	...
	// Creating windows. Fourth parameters tells if we want it as fullscreen
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// so as to keep front pixels actually in front of the ones in the back
		...
		// avoids cpu and gpu at full load
